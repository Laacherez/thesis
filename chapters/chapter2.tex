...
where $\alpha$ encodes where in the time step we evaluate the integral. We need to choose a value for $\alpha$ between $0$ (left endpoint) and $1$ (right endpoint). 
